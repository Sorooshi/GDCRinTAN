...
if __name__ == "__main__":
    ...
    elif "gdcm_fn" in algorithm_name:
    ...
    if run == 1:
        ...
        for repeat in range(1, configs.n_repeats + 1):
            ...
            if "fn" in algorithm_name.lower().split("_"):
                ...
                # Embedding only:
                elif algorithm_name.split("_")[-1].lower() == "e":
                    from gdcm.algorithms.gradient_descent_clustering_methods_embedded_features_networks \
                        import GDCMEfn
